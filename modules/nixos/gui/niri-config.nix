{ ... }:  # Accept self if you need to reference your flake
{
  text = ''
    ...
    input {
        keyboard {
            xkb {
                layout "us"
                // variant "dvorak"
                options "compose:menu,ctrl:nocaps"
            }
        }
    ...
    // Prefer boring rectangles instead of windows drawing custom title bars and
    // other client-side decorations.
    prefer-no-csd
    ...
    binds {
        ...
        Mod+Slash hotkey-overlay-title="Show Notification Center" { spawn "noctalia-shell" "ipc" "call" "notifications" "toggleHistory"; }
        Mod+Ctrl+Slash hotkey-overlay-title="Show Notification Center" { spawn "noctalia-shell" "ipc" "call" "notifications" "toggleDND"; }
        Mod+Ctrl+Shift+Slash hotkey-overlay-title="Show Notification Center" { spawn "noctalia-shell" "ipc" "call" "notifications" "clear"; }
